...
import time
from ismpc_py import State, RotationMatrix
...
class Robot:
    ...
    def __init__(self, skeleton: dart.dynamics.Skeleton):
        ...
        # robot links
        self.lsole = skeleton.getBodyNode("l_sole")
        self.rsole = skeleton.getBodyNode("r_sole")
        self.torso = skeleton.getBodyNode("torso")
        self.base = skeleton.getBodyNode("body")
