...
NB_MODULE(ismpc, m) {
    ...
    nb::class_<EndEffector>(m, "EndEffector")
        ...
        .def(
            "__copy__", [](const EndEffector &self) { return new EndEffector(self); },
    ...
    nb::class_<RotationMatrix>(m, "RotationMatrix")
        ...
        .def(
            "__copy__", [](const RotationMatrix &self) { return new RotationMatrix(self); },
            nb::rv_policy::take_ownership)
    ...
    nb::class_<LipState>(m, "LipState")
        ...
        .def(
            "__copy__", [](const LipState &self) { return new LipState(self); },
            nb::rv_policy::take_ownership)
    ...
    nb::class_<State>(m, "State")
        ...
        .def(
            "__copy__", [](const State &self) { return new State(self); }, nb::rv_policy::take_ownership)
